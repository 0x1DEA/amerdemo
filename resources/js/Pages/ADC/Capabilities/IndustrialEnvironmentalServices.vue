...
<template>
    <Layout>
        <Head>
            <title>Industrial / Environmental Services</title>
        </Head>
                ...
                <div class="relative flex flex-col md:flex-row items-center w-full justify-between gap-8 !mb-4">
                    <div class="y gap-8 md:w-3/5">
                        ...
                        <CoolBox class="max-w-full" title="Material Recycling">
                            ...
                            <br/>
                            <br/>
                            Through American Demolition’s asset recovery services, clients can recoup demolition expenses by salvaging and reselling building contents and scrap that would normally be disposed of in landfills. American Demolition’s LEED-certified personnel can ensure your project will accrue the maximum points to help achieve your specific goals.</CoolBox>
                    </div>
